          ...
          <div className="flex flex-col justify-center">
            <div className="max-w-xl space-y-6">
              ...
              <p className="text-lg md:text-xl text-gray-600">
                Greeny est un bot Discord qui sensibilise à l'écologie, un message à la fois.
              </p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Contenu dynamique, quiz générés et conseils variés grâce à l'intelligence artificielle.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-greeny-500 rounded-full p-1 mr-3 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Toujours disponible pour répondre aux questions et donner des conseils à ta communauté.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-greeny-500 rounded-full p-1 mr-3 mt-1">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800">Approche ludique</h3>
                    <p className="text-gray-600">Sensibilisation positive à travers des défis et des jeux pour motiver et non culpabiliser.</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="section bg-white">
        <div className="container text-center max-w-4xl">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Rejoins des milliers d'utilisateurs qui sensibilisent leur communauté à l'écologie grâce à Greeny.
          </p>
          <Button size="lg" className="bg-greeny-500 hover:bg-greeny-600 text-white rounded-full px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all">
